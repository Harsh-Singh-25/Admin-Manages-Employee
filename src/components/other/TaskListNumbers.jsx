...
const TaskStatsDashboard = ({ data }) => {
  ...
  <motion.div
    className="rounded-xl w-full sm:w-[45%] py-6 px-9 bg-gradient-to-br from-blue-500 to-blue-600 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 transition-all duration-300"
  ...
  <motion.div
    className="rounded-xl w-full sm:w-[45%] py-6 px-9 bg-gradient-to-br from-emerald-500 to-green-600 shadow-lg shadow-green-500/20 hover:shadow-green-500/40 transition-all duration-300"
    variants={cardVariants}
    initial="initial"
    animate="animate"
    whileHover={{ scale: 1.03 }}
  ...
  <motion.div
    className="rounded-xl w-full sm:w-[45%] py-6 px-9 bg-gradient-to-br from-amber-400 to-yellow-500 shadow-lg shadow-amber-500/20 hover:shadow-amber-500/40 transition-all duration-300"
    variants={cardVariants}
    initial="initial"
    animate="animate"
    whileHover={{ scale: 1.03 }}
